...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/RPC.png}
...
Once the disparity has been estimated, $3D$ points can be triangulated by intersecting RPC lines from each matched pixel. There is no guarantee that the 3D lines do indeed intersect. \todoroman{Taille d'un pxel 50cmx50cm, patatoide}
