...
This chapter takes some distance from the stereo vision problem presented previously, and instead describe more formally the different representations of uncertainty and the tools that can be used to manipulate them. We present different models of uncertainty which will be considered in the different contributions of this thesis. We also present a way of aggregating different sources of uncertainty, taking into account their dependency, which will serve to propagate the uncertainty in chapter \ref{chap:propagating} .
...
\section{Specific case of possibility distributions}\label{sec:possibilities}
...
\section{Sampling from a Copula}\label{sec:sampling_copula}
